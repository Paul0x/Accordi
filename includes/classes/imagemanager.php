...
///////////////////////////////////////////////////
//            Accordi - Classes                  //
//            Gerador/Gerenciador de Imagens     //
//            por Paulo Felipe Possa Parreira    //
///////////////////////////////////////////////////
// Changelog:
// v1.0 - Classe criada.
class imagem
{
   ...
   function pegarImagem($imagem)
   {
       ...
       */
      if (!is_array($imagem))
         return "Tipo de imagem inválido. 01";
      if ($imagem['name'] == "" || $imagem['size'] == "" || $imagem['tmp_name'] == "" || $imagem['type'] == "")
         return "Tipo de imagem inválido. 02";
      if (!in_array($imagem['type'], $this->formatos))
         return "Tipo de imagem inválido. 03";
